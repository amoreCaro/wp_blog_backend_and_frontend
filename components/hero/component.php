...
<section class="hero relative min-h-[700px] 2xl:min-h-[800px] 3xl:min-h-[900px] flex flex-col items-center justify-center bg-white dark:bg-[#0F0F11] overflow-hidden px-4 font-sans">
        ...
        if ( ! empty($locations) && ! is_wp_error($locations) ) : ?>
            ...
            <div class="mt-6 md:mt-8 flex flex-wrap justify-center gap-2 sm:gap-4 text-[14px] sm:text-[15px] text-gray font-medium">
                ...
                <?php foreach ( $locations as $location ) : ?>
                    ...
                    class="flex items-center gap-2 bg-[#F5F5F5] dark:bg-[#232125] px-3 py-1.5 sm:px-4 sm:py-2 rounded-full hover:bg-gray-200 hover:text-black dark:hover:text-white transition-all text-sm sm:text-base leading-snug whitespace-nowrap">
